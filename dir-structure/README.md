...
1.  **Context Context:** turning your existing project structure into a text file to show an LLM.
...
This scans your current directory (ignoring system files like `.git`, `__pycache__`, `node_modules`) and generates a file named `directory-structure.txt`.

*   **Output:** A clean, visual tree representation of your project.
...
*   **Exclusions:** The script ignores its own source file, `.git`, `node_modules`, and `.env` files during scanning to prevent clutter.
